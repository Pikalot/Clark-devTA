...
export default function UserNavBar(props) {
  ...
  const adminLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M11 2a1 1 0 0 1 1 1v8a1 1 0 0 1-2 0V3a1 1 0 0 1 1-1zm6 1v3h1V3a1 1 0 0 1 2 0v3a3 3 0 0 1-2 2.83V21a1 1 0 0 1-2 0V8.83A3 3 0 0 1 15 6V3a1 1 0 0 1 2 0zM4 5a1 1 0 0 1 2 0v5.586l.707.707a1 1 0 0 1 0 1.414l-.707.707V21a1 1 0 0 1-2 0v-7.586l-.707-.707a1 1 0 0 1 0-1.414L4 10.586V5z" />
        </svg>
